...
def run(_: Namespace, context: AppContext) -> int:
    ...
    print("----------------------------------------------")
    print("This is a SLURM-managed GPU cluster with these partitions:")
    print(f"  - A40 GPU partition: {config.a40_partition}")
    print(f"  - A6000 GPU partition: {config.a6000_partition}")
    print("")
    ...
    print("----------------------------------------------")
    print(f"  * {config.a40_partition} partition jobs can run up to {config.a40_max_time}")
    print(f"  * {config.a6000_partition} partition jobs can run up to {config.a6000_max_time}")
